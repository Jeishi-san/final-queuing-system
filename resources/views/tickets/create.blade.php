...
<body class="bg-gray-100 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
    ...
    <header class="bg-white dark:bg-gray-800 shadow p-4 flex justify-between items-center">
        ...
        <div class="space-x-3">
            @guest
                <a href="{{ route('login') }}" class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors">Login</a>
                <a href="{{ route('register') }}" class="px-4 py-2 bg-green-500 text-white rounded hover:bg-green-600 transition-colors">Register</a>
            @else
    ...
    <main class="max-w-5xl mx-auto py-10 grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div class="p-6 bg-white dark:bg-gray-800 rounded-xl shadow-lg">
            ...
            <form id="createTicketForm" action="{{ route('tickets.store') }}" method="POST" class="space-y-5">
                ...
                <div>
                    <label for="ticket_number" class="block text-sm font-medium mb-1">Ticket Number (Optional)</label>
                ...
                <div>
                    ...
                    <input type="email" name="team_leader_email" id="team_leader_email"
                           class="w-full border rounded p-2 bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="component_name" id="component_name"
                           placeholder="e.g., Keyboard, Monitor, Printer"
                           class="w-full border rounded p-2 bg-white dark:bg-gray-700 dark:text-white focus:ring-2 focus:ring-blue-500">
                </div>
                ...
                <div class="flex justify-end space-x-3">
                    ...
                    <button type="submit" id="submitBtn"
                            class="px-6 py-2 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors flex items-center">
        ...
        document.addEventListener('DOMContentLoaded', () => {
            ...
            form.addEventListener('submit', async e => {
                ...
                try {
                    ...
                    feedback.innerHTML = `
                        <strong>Success!</strong> Ticket #${data.ticket?.ticket_number || ''} has been created.
                    `;
                    feedback.classList.remove('hidden');

                    form.reset();
                    await refreshPanels(); // refresh side panels
